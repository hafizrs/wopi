...
{
    public class ExportCategoryReportCommandValidatorHandler : IValidationHandler<ExportCategoryReportCommand, CommandResponse>
    {
        private readonly ExportCategoryReportCommandValidator _validator;
        private readonly IPraxisClientService _praxisClientService;

        public ExportCategoryReportCommandValidatorHandler(
            ExportCategoryReportCommandValidator validator, 
        ...
        public CommandResponse Validate(ExportCategoryReportCommand command)
        {
            throw new NotImplementedException();
        }

        public async Task<CommandResponse> ValidateAsync(ExportCategoryReportCommand command)
        {
