...
{
    public class ExportDistinctTaskListReportValidationHandler : IValidationHandler<ExportDistinctTaskListReportCommand, CommandResponse>
    {
        private readonly ExportDistinctTaskListReportCommandValidator validator;
        private readonly IPraxisClientService praxisClientService;

        public ExportDistinctTaskListReportValidationHandler(
            ExportDistinctTaskListReportCommandValidator validator,
        ...
        public CommandResponse Validate(ExportDistinctTaskListReportCommand command)
        {
            throw new NotImplementedException();
        }

        public async Task<CommandResponse> ValidateAsync(ExportDistinctTaskListReportCommand command)
        {
