...
namespace Selise.Ecap.SC.PraxisMonitor.QueryHandlers.RiqsInterface
{
    ...
    public class GetInterfaceManagerLoginFlowQueryHandler : IQueryHandler<GetInterfaceManagerLoginFlowQuery, QueryHandlerResponse>
    {
        private readonly IRiqsInterfaceManagerLoginFlowService _riqsInterfaceManagerLoginFlowService;

        public GetInterfaceManagerLoginFlowQueryHandler(IRiqsInterfaceManagerLoginFlowService riqsInterfaceManagerLoginFlowService)
        {
            _riqsInterfaceManagerLoginFlowService = riqsInterfaceManagerLoginFlowService;
        }

        public QueryHandlerResponse Handle(GetInterfaceManagerLoginFlowQuery query)
        {
            throw new NotImplementedException();
        }

        public async Task<QueryHandlerResponse> HandleAsync(GetInterfaceManagerLoginFlowQuery query)
        {
            ...
            try
            {
                ...
                var results = await _riqsInterfaceManagerLoginFlowService.GetInterfaceManagerLoginFlow(query.Provider);
