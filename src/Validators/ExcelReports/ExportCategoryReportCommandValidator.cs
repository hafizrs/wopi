...
{
    public class ExportCategoryReportCommandValidator : AbstractValidator<ExportCategoryReportCommand>
    {
        public ExportCategoryReportCommandValidator()
        {
        ...
        public ValidationResult IsSatisfiedby(ExportCategoryReportCommand command)
        {
