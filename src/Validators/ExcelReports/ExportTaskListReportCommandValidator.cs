...
{
    public class ExportTaskListReportCommandValidator : AbstractValidator<ExportTaskListReportCommand>
    {
        public ExportTaskListReportCommandValidator()
        {
        ...
        public ValidationResult IsSatisfiedby(ExportTaskListReportCommand command)
        {
