...
{
    public class DeleteSubCategoryDataForClientAdmin : IDeleteDataByRoleSpecific
    {
        private readonly ISecurityContextProvider _securityContextProviderService;
        private readonly ILogger<DeleteSubCategoryDataForClientAdmin> _logger;
        private readonly IBlocksMongoDbDataContextProvider _mongoDbDataContextProvider;

        public DeleteSubCategoryDataForClientAdmin(
            ISecurityContextProvider securityContextProviderService,
            ILogger<DeleteSubCategoryDataForClientAdmin> logger,
